...
public class AuthorizedException extends AbstractSpringWebApplicationException {
	...
	public static final String UNAUTHORIZED_ERROR_CODE = "http.status.unauthorized";
	...
	public AuthorizedException(LoginUser loginUser ) {
		super(getConstructMessage(UNAUTHORIZED_ERROR_CODE,getArgs(loginUser) ) );
		this.httpStatus = HttpStatus.UNAUTHORIZED;
		this.errorCode  = UNAUTHORIZED_ERROR_CODE;
		this.loginUser = loginUser;
		this.args = getArgs(loginUser);
	}
	
	public AuthorizedException(String username, String... roles ) {
		super(getConstructMessage(UNAUTHORIZED_ERROR_CODE, getArgs(username, roles) ) );
		this.httpStatus = HttpStatus.UNAUTHORIZED;
		this.errorCode  = UNAUTHORIZED_ERROR_CODE;
